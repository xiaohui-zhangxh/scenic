module Scenic
  ...
  module Statements
    ...
    #   SQL
    #
    def create_view(name, version: nil, sql_definition: nil, materialized: false, root: nil)
      ...
      sql_definition ||= definition(name, version, root)
    ...
    #
    def update_view(name, version: nil, sql_definition: nil, revert_to_version: nil, materialized: false, root: nil)
      if version.blank? && sql_definition.blank?
        raise(
          ArgumentError,
    ...
    #
    def replace_view(name, version: nil, revert_to_version: nil, materialized: false, root: nil)
      if version.blank?
    ...
    def definition(name, version, root)
      Scenic::Definition.new(name, version, root).to_sql
    end
